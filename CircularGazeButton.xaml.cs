...
namespace SightSignUWP
{
    ...
    public partial class CircularGazeButton : UserControl
    {
        ...
        private void OnProgressButton_Gaze(object sender, System.Timers.ElapsedEventArgs args)
        {
            ...
            // changed from this.Dispatcher.Invoke( new Action () => {} )
        ...
        // changed Systme.Windows.Input.MouseEventArgs ---> Windows.UI.Xaml.Input.PointerRoutedEventArgs
        public void OnTimerStart(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
        ...
        // changed Systme.Windows.Input.MouseEventArgs ---> Windows.UI.Xaml.Input.PointerRoutedEventArgs
        public void OnTimerEnd(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            gazeTimer.Enabled = false;
            intervolTimer.Enabled = false;
            TimerCount = 0;
