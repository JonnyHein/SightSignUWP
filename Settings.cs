...
namespace SightSignUWP
{
    ...
    public class Settings : INotifyPropertyChanged
    {
        ...
        private void LoadSettings()
        {
            ...
            BackgroundColor = Color.FromArgb(backgroundColorSetting.R, backgroundColorSetting.G, backgroundColorSetting.B);

            var buttonBackgroundColorSetting = Settings1.Default.ButtonBackgroundColor;
            ButtonBackgroundColor = Color.FromArgb(buttonBackgroundColorSetting.R, buttonBackgroundColorSetting.G, buttonBackgroundColorSetting.B);

            var buttonTextColorSetting = Settings1.Default.ButtonTextColor;
            ButtonTextColor = Color.FromArgb(buttonTextColorSetting.R, buttonTextColorSetting.G, buttonTextColorSetting.B);

            var buttonBorderColorSetting = Settings1.Default.ButtonBorderColor;
            ButtonBorderColor = Color.FromArgb(buttonBorderColorSetting.R, buttonBorderColorSetting.G, buttonBorderColorSetting.B);

            ButtonBorderWidth = Settings1.Default.ButtonBorderWidth;

            var inkColorSetting = Settings1.Default.InkColor;
            InkColor = Color.FromArgb(inkColorSetting.R, inkColorSetting.G, inkColorSetting.B);
